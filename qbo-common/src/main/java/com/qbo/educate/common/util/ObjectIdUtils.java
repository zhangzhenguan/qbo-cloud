package com.qbo.educate.common.util;
...
public class ObjectIdUtils {
    ...
    static {
        try {
            ...
            ClassLoader loader = ObjectIdUtils.class.getClassLoader();
    ...
    public static void main(String[] args) {
        System.out.println(ObjectIdUtils.next());
        System.out.println(ObjectIdUtils.nextWithUnderline());
    }
