...
import com.qbo.educate.auth.bean.ClientInfo;
import com.qbo.educate.auth.mapper.ClientMapper;
import com.qbo.educate.auth.service.AuthClientService;
import com.qbo.educate.auth.util.client.ClientTokenUtil;
import com.qbo.educate.common.exception.auth.ClientInvalidException;
import com.qbo.educate.common.util.UUIDUtils;
